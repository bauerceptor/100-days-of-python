class WarCardGame:
    ...
    def __init__(self, player, computer, deck):
        ...
        self.make_initial_decks()    # deck builds automatically when the game starts
    ...
    def make_deck(self, character):
        # character is a generic variable representing the player or the computer
        for _ in range(26):
    ...
    def start_war(self, cards_from_battle):
        ...
        for _ in range(3):
            # take the player's card and append it to the list
            player_card = self._player.draw_card()
            player_cards.append(player_card)

            # take the computer's card and append it to the list
            computer_card = self._computer.draw_card()
            computer_cards.append(computer_card)

        print("Six hidden cards: 🃏🃏🃏 🃏🃏🃏")

        # calling the battle function again with all available lists of cards
